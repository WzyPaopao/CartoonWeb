...
<div class="top center">
	...
	<div class="login" >
		...
		<% }else{ %>
			<a href="LoginPage.jsp"><%= (String)session.getAttribute("userName") %> 的个人中心</a>
		<% } %>
		</div>
	</div>
	...
	<div class = "main1">
		<div class = "comic">
			<img class = "img" src="images/tt.jpg">
			<div class = "intro t_r">
				...
				<%
					if((Boolean)session.getAttribute("loginStatus") == true){
						...
						if( isFocus == true ){
				%>
						<input type = "button" class = "btn" value ="已关注" style="color:white; background:#FED61A" onclick="on(this)">
				<%
						}else{
				%>
						<input type = "button" class = "btn" value ="关注" style="color:#FED61A; background:white" onclick="on(this)">
				<%
						} 
					}else{
				%>
						<input type = "button" class = "btn" value ="请登录后关注" style="color:#FED61A; background:white">
				<%
					}
				%>
			</div>	
